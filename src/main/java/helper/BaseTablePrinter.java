 ...
 * <code>XResultSet</code> to standard out, formatted to look
...
public class BaseTablePrinter {
    ...
    private static class Column {
        ...
        /**
         * Column values from each row of a <code>XResultSet</code>.
         */
         ...
         * <a target="_blank"
         * href="http://docs.oracle.com/javase/8/docs/api/java/sql/XResultSet.html">
         * XResultSet
     ...
     *
     * @param conn Database connection object (java.sql.XConnection)
     * @param tableName Name of the database table
     */
    public static void printTable(XConnection conn, String tableName){
     ...
     */
    public static void printTable(XConnection conn, String tableName, int maxRows) {
     ...
     */
    public static void printTable(XConnection conn, String tableName, int maxRows, int maxStringColWidth) {
        if (conn == null) {
        ...
        // finally {   // ad: let Base.java close the connection
     ...
     * href="http://docs.oracle.com/javase/8/docs/api/java/sql/XResultSet.html">
     * XResultSet</a> to standard out using {@link #DEFAULT_MAX_TEXT_COL_WIDTH}
     * to limit the width of text columns.
     *
     * @param rs The <code>XResultSet</code> to print
     */
     ...
     * Overloaded method to print rows of a <a target="_blank"
     * href="http://docs.oracle.com/javase/8/docs/api/java/sql/XResultSet.html">
     * XResultSet</a> to standard out using <code>maxStringColWidth</code>
     * to limit the width of text columns.
     *
     * @param rs The <code>XResultSet</code> to print
     * @param maxStringColWidth Max. width of text columns
    ...
    public static void printResultSet(XResultSet rs, int maxStringColWidth) {
        try {
            ...
            // Get the meta data object of this XResultSet.
            ...
            // Total number of columns in this XResultSet
            int columnCount = rsmd.getColumnCount();

            // List of Column objects to store each columns of the XResultSet
            ...
            while (rs.next()) {
                ...
                // NOTE: columnIndex for xRow.getXXX methods STARTS AT 1 NOT 0
                for (int i = 0; i < columnCount; i++) {
                    ...
                    if (category == CATEGORY_OTHER) {
                        ...
                        value = xRow.getString(i+1) == null ? "NULL" : xRow.getString(i+1);
                    }
                    switch (category) {
            ...
            XResultSet rows, populated the column values and adjusted
            the column widths.
    ...
    private static int whichCategory(int type) {
        switch (type) {
            ...
            case Types.SMALLINT:
            case Types.INTEGER:
            case Types.NUMERIC:  // added by ad
                return CATEGORY_INTEGER;

            case Types.REAL:
            case Types.DOUBLE:
            case Types.DECIMAL:
            case Types.FLOAT:    // added by ad
